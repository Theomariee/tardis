 ...
 */
final class Version20180702214305 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE etudiant_filiere (etudiant_id INT NOT NULL, filiere_id INT NOT NULL, semestre_id INT NOT NULL, PRIMARY KEY(etudiant_id, filiere_id))');
